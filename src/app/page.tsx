  ...
  return (
    <div className="mx-4">
      ...
      <Pagination>
        <PaginationContent>
          <PaginationItem>
            <PaginationLink href="#"><div className="rounded-full bg-primary w-1 h-1 p-2"></div></PaginationLink>
          </PaginationItem>
          <PaginationItem>
            <PaginationLink href="#"><div className="rounded-full bg-[#D9D9D9] w-1 h-1 p-2" /></PaginationLink>
          </PaginationItem>
          <PaginationItem>
            <PaginationLink href="#"><div className="rounded-full bg-[#D9D9D9] w-1 h-1 p-2" /></PaginationLink>
          </PaginationItem>
